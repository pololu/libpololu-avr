...
arduino-0011/hardware/libraries directory. If you don't perform this
step, the newer version of the libraries might not get compiled.

Extract this archive to your arduino-0011/hardware/libraries
directory.
...
0011 IDE (or simply type #include <Orangutan_____.h> at the top of
